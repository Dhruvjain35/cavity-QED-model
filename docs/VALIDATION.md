...
This is the credibility artifact for **polariton-sim**: the consolidated record of
...
If you want to audit this code, the honest summary is: every number the simulator can
...
tolerance. The tables below are the receipts.
...
|---|---|---|---|
| Coherent `|α=1+0.5i>` | `2.220e-16` | `1.000000` | — |
